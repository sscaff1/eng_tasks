<div class="taskTypes index">
	...
	<tr>
		...
		<td><?php echo h($taskType['TaskType']['active']); ?>&nbsp;</td>
		<td><?php echo h($taskType['TaskType']['created']); ?>&nbsp;</td>
		<td><?php echo h($taskType['TaskType']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $taskType['TaskType']['id']), array(), __('Are you sure you want to delete # %s?', $taskType['TaskType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
